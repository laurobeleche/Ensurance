...
This mechanism has been integrated into Bitcore-Node-Insurance which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/insurance/insight-api-insurance#web-socket-api](https://github.com/insurance/insight-api-insurance#web-socket-api)
* API: [https://github.com/insurance/insight-api-insurance#swifttx-transactions](https://github.com/insurance/insight-api-insurance#swifttx-transactions)
...
By default, the Insurance Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Insurance Core daemon:
