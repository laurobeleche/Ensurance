...
This mechanism has been integrated into Bitcore-Node-Ensurance which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ensurance/insight-api-ensurance#web-socket-api](https://github.com/ensurance/insight-api-ensurance#web-socket-api)
* API: [https://github.com/ensurance/insight-api-ensurance#swifttx-transactions](https://github.com/ensurance/insight-api-ensurance#swifttx-transactions)
...
By default, the Ensurance Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Ensurance Core daemon:
