...
In order to support loading of multiple wallets in insurance-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is insurance.cpp.
...
Changes to insurance.cpp
----------------------
insurance.cpp is the entry point into insurance-qt, and as such, will require some minor modifications to provide hooks for
