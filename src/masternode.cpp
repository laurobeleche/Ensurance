...
bool CMasternodeBroadcast::CheckAndUpdate(int& nDos)
{
    ...
    // if (Params().NetworkID() == CBaseChainParams::MAIN) {
    //     if (addr.GetPort() != 22150) return false;
    // } else if (addr.GetPort() == 22150)
    //     return false;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 2500 SEC tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = 0;
    CTransaction tx2;
