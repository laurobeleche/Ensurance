...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SEC);
    unitlist.append(mSEC);
    unitlist.append(uSEC);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SEC:
            return QString("tSEC");
        case mSEC:
            return QString("mtSEC");
        case uSEC:
            return QString::fromUtf8("μtSEC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SEC:
            return QString("SEC");
        case mSEC:
            return QString("Milli-SEC (1 / 1" THIN_SP_UTF8 "000)");
        case uSEC:
            return QString("Micro-SEC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case SEC:
            return QString("TestSECs");
        case mSEC:
            return QString("Milli-TestSEC (1 / 1" THIN_SP_UTF8 "000)");
        case uSEC:
            return QString("Micro-TestSEC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
