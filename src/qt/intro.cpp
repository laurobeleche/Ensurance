...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Ensurance Core"),
     ...
     * override -datadir in the ensurance.conf file in the default data directory
     * (to be consistent with ensuranced behavior)
     */
    if (dataDir != getDefaultDataDirectory())
