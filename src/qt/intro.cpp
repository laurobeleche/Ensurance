...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Insurance Core"),
     ...
     * override -datadir in the insurance.conf file in the default data directory
     * (to be consistent with insuranced behavior)
     */
    if (dataDir != getDefaultDataDirectory())
