                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Ensurance Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SEC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ensurance: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Ensurance Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ensurance Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ensurance"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SEC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SEC addresses"));
    ...
    openAction->setStatusTip(tr("Open a ensurance: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ensurance Core help message to get a list with possible Ensurance command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Ensurance Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ensurance network", "", count));
}
...
{
    QString strTitle = tr("Ensurance Core"); // default title
