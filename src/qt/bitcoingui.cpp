                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Insurance Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and insurance: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Insurance Core"), this);
    aboutAction->setStatusTip(tr("Show information about Insurance Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Insurance"));
    ...
    openAction->setStatusTip(tr("Open a insurance: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Insurance Core help message to get a list with possible Insurance command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Insurance Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Insurance network", "", count));
}
...
{
    QString strTitle = tr("Insurance Core"); // default title
