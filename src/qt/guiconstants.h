...
/* Insurance GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Insurance"
#define QAPP_ORG_DOMAIN "insurancecoin.io"
#define QAPP_APP_NAME_DEFAULT "Insurance-Qt"
#define QAPP_APP_NAME_TESTNET "Insurance-Qt-testnet"
