...
/** Utility functions used by the Ensurance Qt UI.
 */
namespace GUIUtil
{
...
// Render SEC addresses in monospace font
...
// Parse "ensurance:" URI into recipient object, return true on successful parsing
