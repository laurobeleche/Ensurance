...
{
    // return if URI is not valid or is no insurance: URI
...
{
    // Convert insurance:// to insurance:
    //
    //    Cannot handle this later, because insurance:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open insurance.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Insurance.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for Insurance.lnk
...
{
    return GetAutostartDir() / "insurance.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a insurance.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=Insurance\n";
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the insurance app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add insurance app to startup item list
