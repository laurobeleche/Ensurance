...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/insurance-cli.cpp \
           src/insurance-tx.cpp \
           src/insurance.cpp \
           src/db.cpp \
           ...
           src/qt/insurance.cpp \
           src/qt/insurancestrings.cpp \
...
RESOURCES += src/qt/insurance.qrc src/qt/insurance_locale.qrc

TRANSLATIONS += src/qt/locale/insurance_bg.ts \
                src/qt/locale/insurance_de.ts \
                src/qt/locale/insurance_en.ts \
                src/qt/locale/insurance_es.ts \
                src/qt/locale/insurance_fi.ts \
                src/qt/locale/insurance_fr.ts \
                src/qt/locale/insurance_it.ts \
                src/qt/locale/insurance_ja.ts \
                src/qt/locale/insurance_pl.ts \
                src/qt/locale/insurance_pt.ts \
                src/qt/locale/insurance_ru.ts \
                src/qt/locale/insurance_sk.ts \
                src/qt/locale/insurance_sv.ts \
                src/qt/locale/insurance_vi.ts \
                src/qt/locale/insurance_zh_CN.ts \
                src/qt/locale/insurance_zh_TW.ts
