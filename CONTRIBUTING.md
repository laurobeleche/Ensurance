Contributing to Ensurance Core
==================================

The Ensurance Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Ensurance Core project, and is not to be
confused with overall Ensurance Network Protocol consensus changes.

Whether a pull request is merged into Ensurance Core rests with the project merge
...
Patches that change Ensurance consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ensurance consensus, it must have been
...
The project leader is the release manager for each Ensurance Core release.
