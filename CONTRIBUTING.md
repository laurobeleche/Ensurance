Contributing to Insurance Core
==================================

The Insurance Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Insurance Core project, and is not to be
confused with overall Insurance Network Protocol consensus changes.

Whether a pull request is merged into Insurance Core rests with the project merge
...
Patches that change Insurance consensus rules are considerably more involved than
...
Where a patch set proposes to change the Insurance consensus, it must have been
...
The project leader is the release manager for each Insurance Core release.
