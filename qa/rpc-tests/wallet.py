...
#   c) node1 mines 32 blocks, so now node 0 has 500000SEC, node 1 has 4250SEC, node2 has none.
#   d) node0 sends 601 SEC to node2, in two transactions (301 SEC, then 300 SEC).
